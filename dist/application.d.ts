...
declare const NodeCrudApiLoopbackApplication_base: (new (...args: any[]) => {
    [x: string]: any;
    projectRoot: string;
...
export declare class NodeCrudApiLoopbackApplication extends NodeCrudApiLoopbackApplication_base {
